...
export const projects: Project[] = [
  {
    ...
    whatBuilt:
      'grammY-бот, React Mini App, Fastify API, PostgreSQL-очередь, FFmpeg-воркер, платёжные адаптеры (ЮKassa / Stars, приём платежей выключен), запуск на VPS и тесты.',
    ownership: 'Продуктовый сценарий, интерфейс, сервер, очередь, инфраструктура и запуск.',
    stack: [
      'TypeScript',
      'React',
      'Fastify',
    ...
    poster: '/media/fadeline/poster.webp',
    posterAlt: 'FADELINE Mini App: статус «Готово», файл уже в чате с ботом',
    mediaKind: 'phone',
    stills: [
      { src: '/media/fadeline/poster.webp', alt: 'Готовый микс' },
      { src: '/media/fadeline/still-projects.webp', alt: 'Список проектов' },
      { src: '/media/fadeline/still-create.webp', alt: 'Создание проекта' },
      { src: '/media/fadeline/still-processing.webp', alt: 'Обработка' },
      { src: '/media/fadeline/still-detail.webp', alt: 'Карточка проекта' },
    ],
    localVideo: '',
    ...
    footnote:
      'Рабочий прототип. Платежи в коде есть, приём денег выключен. Запись — на YouTube.',
  },
  {
    id: 'optbot',
    tab: 'ОптБот',
    ...
    githubUrl: '',
    footnote:
      'Демо-бот сейчас не крутится на VPS. Сценарий рабочий. Запись на YouTube появится здесь, когда будет ссылка. Реквизиты на счёте — демо, не клиент.',
  },
  {
    id: 'deckflow',
    tab: 'DeckFlow',
    ...
    whatBuilt:
      'Electron-приложение: деки, волна, BPM, трёхполосный EQ, кроссфейдер, горячие точки, MIDI Learn, русские подсказки. Сборка .dmg без подписи Gatekeeper.',
    ownership: 'Продуктовая логика, интерфейс, аудиодвижок, интеграция с Mac и сборка.',
    ...
    mediaKind: 'desktop',
    stills: [
      { src: '/media/deckflow/poster.webp', alt: 'Полный интерфейс' },
      { src: '/media/deckflow/still-mixer.webp', alt: 'Микшер' },
    ],
    localVideo: '',
    youtubeUrl: '',
    githubUrl: '',
  ...
  },
  {
    ...
    whatBuilt:
      'Бот (доступ, оплата Премиума, поддержка, реферальная программа, новости), Mini App, ИИ с лимитами, практики, тесты с историей, сборка PDF. Сайт cozyreset.ru.',
    ...
    poster: '/media/cozyreset/card.svg',
  ...
  },
  {
    ...
    flow: ['Telegram-бот', 'Название работы или вакансия', 'Подбор навыков', 'Черновик резюме', 'Файл на выходе'],
    whatSolved:
      'Убрал ручной подбор навыков «из головы»: из названия вакансии собирается набор навыков и черновик резюме.',
    whatBuilt:
    ...
    poster: '/media/resumebot/card.svg',
